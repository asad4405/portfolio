    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="my-2 pull-left">
                <h4 class="text-blue h4">Portfolio Section</h4>
            </div>
            <div class="pull-right">
                <a href="{{ route('admin.portfolio.create') }}" class="btn btn-primary btn-sm scroll-click"><i
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.portfolio.edit', $value->id) }}"><i
