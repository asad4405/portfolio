    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            ...
            <div class="pull-right">
                <a href="{{ route('admin.preparation.create') }}" class="btn btn-primary btn-sm scroll-click"><i class="fa fa-plus"></i> Create</a>
            </div>
        </div>
        @if (session('success'))
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.preparation.edit',$value->id) }}"><i class="dw dw-edit2"></i> Edit</a>
                                        <form action="{{ route('admin.preparation.destroy',$value->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
