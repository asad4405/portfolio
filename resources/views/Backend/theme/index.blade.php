    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="my-2 pull-left">
                <h4 class="text-blue h4">Theme Section</h4>
            </div>
            <div class="pull-right">
                <a href="{{ route('admin.theme.create') }}" class="btn btn-primary btn-sm scroll-click"><i
        ...
        <div class="pb-20">
            <table class="table data-table stripe hover nowrap">
                ...
                <tbody>
                    @forelse ($themes as $value)
                        <tr>
                            <td class="table-plus">{{ $loop->index + 1 }}</td>
                            <td>{{ $value->theme_type }}</td>
                            <td>{{ $value->name }}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.theme.edit', $value->id) }}"><i
                                                class="dw dw-edit2"></i> Edit</a>
                                        <form action="{{ route('admin.theme.destroy', $value->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
