...
@section('content')
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#logo-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Logo</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="logo-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="">
                    ...
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Show Logo</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Logo  -->
            ...
            <li class="nav-item">
                ...
                <ul id="banner-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Show Banner</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Banner  -->
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('backend_assets') }}/img/product-1.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('backend_assets') }}/img/product-2.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('backend_assets') }}/img/product-3.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('backend_assets') }}/img/product-4.jpg"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('backend_assets') }}/img/product-5.jpg"
                                                            alt=""></a></th>
