                        ...
                        <div id="gallery" class="gallery full-gallery de-gallery pf_full_width pf_3_cols grid sequence">
                            ...
                            <div class="item illustration website gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(1).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(1).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                            ...
                            <div class="item photography gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(2).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(2).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                            ...
                            <div class="item illustration gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(3).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(3).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                            ...
                            <div class="item photography illustration mobile gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(4).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(4).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                            ...
                            <div class="item photography mobile website gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(5).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(5).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                            ...
                            <div class="item mobile website gallery-item">
                                <div class="picframe wow">
                                    <a class="image-popup" href="{{ asset('frontend_assets') }}/images/portfolio/pf%20(6).jpg">
                                        <span class="overlay">
                                            <span class="pf_text">
                                                <span class="project-name">Project Name</span>
                                            </span>
                                        </span>
                                        <img src="{{ asset('frontend_assets') }}/images/portfolio/pf%20(6).jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <!-- close gallery item -->
                    ...
                    <div id="testimonial-carousel" class="de_carousel sequence" data-wow-delay=".3s">
                            ...
                            <div class="de_testi opt-2">
                                <blockquote>
                                    <div class="de_testi_by">
                                        <img src="{{ asset('frontend_assets') }}/images/people/1.jpg" class="img-circle" alt="">
                        ...
                        <div class="col-md-6 item sq-item wow">
                            <div class="de_testi opt-2">
                                <blockquote>
                                    <div class="de_testi_by">
                                        <img src="{{ asset('frontend_assets') }}/images/people/2.jpg" class="img-circle" alt="">
                        ...
                        <div class="col-md-6 item sq-item wow">
                            <div class="de_testi opt-2">
                                <blockquote>
                                    <div class="de_testi_by">
                                        <img src="{{ asset('frontend_assets') }}/images/people/3.jpg" class="img-circle" alt="">
                        ...
                        <div class="col-md-6 item sq-item wow">
                            <div class="de_testi opt-2">
                                <blockquote>
                                    <div class="de_testi_by">
                                        <img src="{{ asset('frontend_assets') }}/images/people/4.jpg" class="img-circle" alt="">
